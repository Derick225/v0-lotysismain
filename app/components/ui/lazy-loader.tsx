  ...
  return (
    <div className="flex items-center justify-center p-8">
      <div className="flex items-center gap-3">
        <OptimizedIcon name="RefreshCw" className="animate-spin" size={20} />
  ...
  return (
    <Card className="border-red-200 bg-red-50">
      <CardContent className="p-6 text-center">
        <OptimizedIcon name="AlertCircle" className="mx-auto mb-4 text-red-500" size={32} />
        ...
        {retry && (
          ...
          >
            <OptimizedIcon name="RefreshCw" size={16} />
            Réessayer
          </button>
        )}
      </CardContent>
